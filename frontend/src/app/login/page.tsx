      ...
      <div className="flex-1 px-6">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border theme-border theme-bg-card py-4 rounded-xl font-medium theme-text-primary active:opacity-80 transition-colors"
          >
